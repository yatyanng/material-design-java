                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <p>The first step is to create an account at
                                                                            <a href="https://github.com/yatyanng/material-design-java/">Learning Yan</a>. You can choose a social network or go for the classic version, whatever works best for you.</p>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="picture">
                                                                            <img src="../lib/img/card-1.jpeg" alt="Thumbnail Image" class="img-rounded img-responsive">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="instruction">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="picture">
                                                                            <img src="../lib/img/card-2.jpeg" alt="Thumbnail Image" class="img-rounded img-responsive">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
